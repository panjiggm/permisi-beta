    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="JamSite - Custom Jamstack website by request"
            description="Kami membuat website atau aplikasi sesuai permintaan kamu,
            tentunya dengan teknologi Jamstack sebagai keunggulan kami"
          />
