      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          ...
          <Box sx={styles.rightContent}>
            <SectionHeading
              sx={styles.heading}
              title="JamSite untuk apapun dan siapapun"
              description="Kami menawarkan website yang sudah umum digunakan sperti Company Profile, Blog, Ecoommerce, dsb. Namun ditopang dengan teknologi JamStack sebagai keunggulan yang kami tawarkan"
            />
