    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Beliyuk - A minimum superset ecommerce"
            description="Template e-commerce dengan 3 jenis pilihan paket untuk kebutuhan
            mengiklankan atau mengkatalogkan produk kamu supaya mudah dalam
            menjualnya"
          />
          <Box as="figure" sx={styles.illustration}>
            <a href="https://beliyuk.co" target="_blank_">
